...
exports.MEAL_RATIOS = exports.AGGRESSIVE_RISK_TIP = exports.GOAL_OPTIONS = exports.ACTIVITY_OPTIONS = exports.BODY_FAT_UNUSED_NOTE = exports.BODY_FAT_TIP = exports.TRAINING_DAYS_TIP = exports.SELECT_SEX_TIP = exports.SELECT_GOAL_TIP = exports.SELECT_ACTIVITY_TIP = exports.EMPTY_TIP = void 0;
exports.splitMeals = splitMeals;
exports.trainingCarbHint = trainingCarbHint;
exports.tipsForGoal = tipsForGoal;
exports.goalDeltaNote = goalDeltaNote;
exports.EMPTY_TIP = '请完整填写后再计算';
exports.SELECT_ACTIVITY_TIP = '请选择日常活动水平';
exports.SELECT_GOAL_TIP = '请选择训练目标';
exports.SELECT_SEX_TIP = '请选择性别';
exports.TRAINING_DAYS_TIP = '每周训练频率请填写 0–7 的整数';
exports.BODY_FAT_TIP = '体脂率请填写 1–60 之间的数字，或不填';
exports.BODY_FAT_UNUSED_NOTE = '未参与本次核心热量计算（BMR 采用 Mifflin-St Jeor）';
...
exports.AGGRESSIVE_RISK_TIP = '快速减脂缺口更大，更易疲劳、掉肌肉与反弹。若出现明显不适请及时提高摄入并放缓节奏，不建议长期极端节食。';
exports.MEAL_RATIOS = {
    breakfast: 0.3,
    lunch: 0.4,
    dinner: 0.3,
};
function splitMeals(targetKcal) {
    const breakfast = Math.round(targetKcal * exports.MEAL_RATIOS.breakfast);
    const dinner = Math.round(targetKcal * exports.MEAL_RATIOS.dinner);
...
function trainingCarbHint(days) {
    if (days <= 0) {
...
function tipsForGoal(goal, bmrFloorApplied) {
...
function goalDeltaNote(goal, deltaKcal, deltaMin, deltaMax) {
    if (goal === 'cutMild') {
