...
<!--
  Map this feature to PeakMeet Constitution. Specs that violate NON-NEGOTIABLE
  principles MUST be revised before planning.
-->

### In Scope / Out of Scope

- **In scope**: [capabilities allowed under Product Boundaries for 小程序 and/or Web]
- **Out of scope**: [explicit exclusions, e.g., 社区/运营后台/Web 完整动作库/SSR/自建后端]
...
- [ ] No medical/treatment claims; disclaimer required on calculators/guidance
